...
## Usage
Please see [godoc.org](http://godoc.org/github.com/develersrl/gatt) for documentation.
...
Please check [#32](https://github.com/develersrl/gatt/issues/32) for the status of this issue.
